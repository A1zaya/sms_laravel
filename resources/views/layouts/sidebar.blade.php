<div class="sidebar hidden sm:block w-0 sm:w-1/6 bg-orange-200 h-screen shadow fixed top-0 left-0 bottom-0 z-40 overflow-y-auto">
    <div class="mb-6 mt-20 px-6">
        <a href="{{ route('home') }}" class="flex items-center text-black-600 py-2 hover:text-orange-700">
        ...
        @role('Admin')
        <a href="{{ route('teacher.index') }}" class="flex items-center text-black-600 py-2 hover:text-orange-700">
        ...
        <a href="{{ route('subject.index') }}" class="flex items-center text-black-600 py-2 hover:text-orange-700">
        ...
        <a href="{{ route('parents.index') }}" class="flex items-center text-black-600 py-2 hover:text-orange-700">
        ...
        <a href="{{ route('student.index') }}" class="flex items-center text-black-600 py-2 hover:text-orange-700">
